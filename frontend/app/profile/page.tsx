          ...
          <div className="flex flex-col gap-8 md:flex-row md:items-start">
            <div className="group relative">
              ...
              <button
                ...
                className="absolute bottom-0 right-0 rounded-full border-2 border-white bg-[#7A1F1F] p-2 text-white shadow-lg transition-all hover:bg-[#5a1616]"
                title="Preview a profile photo locally"
              >
                <CameraIcon />
              </button>
